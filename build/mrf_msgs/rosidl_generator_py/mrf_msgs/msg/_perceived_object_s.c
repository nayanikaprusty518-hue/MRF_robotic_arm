...
bool mrf_msgs__msg__perceived_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mrf_msgs.msg._perceived_object.PerceivedObject", full_classname_dest, 46) == 0);
  }
  mrf_msgs__msg__PerceivedObject * ros_message = _ros_message;
  {  // object_id
...
PyObject * mrf_msgs__msg__perceived_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mrf_msgs.msg._perceived_object");
