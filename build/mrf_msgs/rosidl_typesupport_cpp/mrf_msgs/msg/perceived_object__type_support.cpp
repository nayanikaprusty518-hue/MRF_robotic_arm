...
static const _PerceivedObject_type_support_symbol_names_t _PerceivedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mrf_msgs, msg, PerceivedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mrf_msgs, msg, PerceivedObject)),
  }
};
...
get_message_type_support_handle<mrf_msgs::msg::PerceivedObject>()
{
  return &::mrf_msgs::msg::rosidl_typesupport_cpp::PerceivedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mrf_msgs, msg, PerceivedObject)() {
  return get_message_type_support_handle<mrf_msgs::msg::PerceivedObject>();
}
