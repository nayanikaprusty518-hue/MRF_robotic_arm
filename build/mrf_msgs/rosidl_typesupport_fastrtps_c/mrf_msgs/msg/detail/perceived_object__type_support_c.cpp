...
#include "mrf_msgs/msg/detail/perceived_object__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // category, object_id
#include "rosidl_runtime_c/string_functions.h"  // category, object_id
...
using _PerceivedObject__ros_msg_type = mrf_msgs__msg__PerceivedObject;
  ...
  void * untyped_ros_message)
{
  ...
  _PerceivedObject__ros_msg_type * ros_message = static_cast<_PerceivedObject__ros_msg_type *>(untyped_ros_message);
  // Field name: object_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _PerceivedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mrf_msgs__msg__PerceivedObject(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mrf_msgs__msg__PerceivedObject;
    is_plain =
      (
...
static size_t _PerceivedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mrf_msgs__msg__PerceivedObject(
